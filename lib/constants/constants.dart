...
const String APP_VERSION_NAME = "Android v1.0.7 & iOS v1.0.7";
const int ANDROID_APP_VERSION_NUMBER = 7; // Google Play Version Number
const int IOS_APP_VERSION_NUMBER = 7; // App Store Version Number
// 
...
/// DATABASE FIELDS FOR USER COLLECTION  ///937/
///
